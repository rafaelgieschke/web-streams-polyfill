...
"use strict";function _defineProperty(e,r,t){return r in e?Object.defineProperty(e,r,{value:t,enumerable:!0,configurable:!0,writable:!0}):e[r]=t,e}function _toConsumableArray(e){if(Array.isArray(e)){for(var r=0,t=Array(e.length);r<e.length;r++)t[r]=e[r];return t}return Array.from(e)}Object.defineProperty(exports,"__esModule",{value:!0});var _require=_dereq_("./spec/reference-implementation/lib/readable-stream"),ReadableStream=_require.ReadableStream,_require2=_dereq_("./spec/reference-implementation/lib/writable-stream"),WritableStream=_require2.WritableStream,ByteLengthQueuingStrategy=_dereq_("./spec/reference-implementation/lib/byte-length-queuing-strategy"),CountQueuingStrategy=_dereq_("./spec/reference-implementation/lib/count-queuing-strategy"),_require3=_dereq_("./spec/reference-implementation/lib/transform-stream"),TransformStream=_require3.TransformStream;exports.ByteLengthQueuingStrategy=ByteLengthQueuingStrategy,exports.CountQueuingStrategy=CountQueuingStrategy,exports.ReadableStream=ReadableStream,exports.WritableStream=WritableStream,exports.TransformStream=TransformStream;var interfaces={ReadableStream:ReadableStream,WritableStream:WritableStream,ByteLengthQueuingStrategy:ByteLengthQueuingStrategy,CountQueuingStrategy:CountQueuingStrategy,TransformStream:TransformStream};exports.default=interfaces,"undefined"!=typeof window&&Object.assign.apply(Object,[window].concat(_toConsumableArray(Object.keys(interfaces).filter(function(e){return!(e in window)}).map(function(e){return _defineProperty({},e,interfaces[e])}))));
...
"use strict";function _classCallCheck(r,e){if(!(r instanceof e))throw new TypeError("Cannot call a class as a function")}function IsTransformStream(r){return!!typeIsObject(r)&&!!Object.prototype.hasOwnProperty.call(r,"_transformStreamController")}function TransformStreamError(r,e){verbose("TransformStreamError()"),"readable"===r._readable._state&&ReadableStreamDefaultControllerError(r._readable._readableStreamController,e),TransformStreamErrorWritableAndUnblockWrite(r,e)}function TransformStreamErrorWritableAndUnblockWrite(r,e){WritableStreamDefaultControllerErrorIfNeeded(r._writable._writableStreamController,e),!0===r._backpressure&&TransformStreamSetBackpressure(r,!1)}function TransformStreamSetBackpressure(r,e){verbose("TransformStreamSetBackpressure() [backpressure = "+e+"]"),void 0!==r._backpressureChangePromise&&r._backpressureChangePromise_resolve(),r._backpressureChangePromise=new Promise(function(e){r._backpressureChangePromise_resolve=e}),r._backpressure=e}function IsTransformStreamDefaultController(r){return!!typeIsObject(r)&&!!Object.prototype.hasOwnProperty.call(r,"_controlledTransformStream")}function TransformStreamDefaultControllerEnqueue(r,e){verbose("TransformStreamDefaultControllerEnqueue()");var a=r._controlledTransformStream,t=a._readable._readableStreamController;if(!1===ReadableStreamDefaultControllerCanCloseOrEnqueue(t))throw new TypeError("Readable side is not in a state that permits enqueue");try{ReadableStreamDefaultControllerEnqueue(t,e)}catch(r){throw TransformStreamErrorWritableAndUnblockWrite(a,r),a._readable._storedError}ReadableStreamDefaultControllerHasBackpressure(t)!==a._backpressure&&TransformStreamSetBackpressure(a,!0)}function TransformStreamDefaultControllerError(r,e){TransformStreamError(r._controlledTransformStream,e)}function TransformStreamDefaultControllerTerminate(r){verbose("TransformStreamDefaultControllerTerminate()");var e=r._controlledTransformStream,a=e._readable._readableStreamController;!0===ReadableStreamDefaultControllerCanCloseOrEnqueue(a)&&ReadableStreamDefaultControllerClose(a),TransformStreamErrorWritableAndUnblockWrite(e,new TypeError("TransformStream terminated"))}function TransformStreamDefaultSinkInvokeTransform(r,e){var a=r._transformStreamController,t=r._transformer,o=t.transform;if(void 0!==o)return Call(o,t,[e,a]);TransformStreamDefaultControllerEnqueue(a,e)}function TransformStreamDefaultSinkTransform(r,e){verbose("TransformStreamDefaultSinkTransform()");var a=r._ownerTransformStream,t=void 0;try{var o=TransformStreamDefaultSinkInvokeTransform(a,e);t=Promise.resolve(o)}catch(r){t=Promise.reject(r)}return t.catch(function(r){throw TransformStreamError(a,r),r})}function defaultControllerBrandCheckException(r){return new TypeError("TransformStreamDefaultController.prototype."+r+" can only be used on a TransformStreamDefaultController")}function streamBrandCheckException(r){return new TypeError("TransformStream.prototype."+r+" can only be used on a TransformStream")}var _createClass=function(){function defineProperties(r,e){for(var a=0;a<e.length;a++){var t=e[a];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(r,t.key,t)}}return function(r,e,a){return e&&defineProperties(r.prototype,e),a&&defineProperties(r,a),r}}(),assert=_dereq_("better-assert"),verbose=_dereq_("debug")("streams:transform-stream:verbose"),_require=_dereq_("./helpers.js"),Call=_require.Call,InvokeOrNoop=_require.InvokeOrNoop,PromiseInvokeOrNoop=_require.PromiseInvokeOrNoop,typeIsObject=_require.typeIsObject,createDataProperty=_require.createDataProperty,_require2=_dereq_("./readable-stream.js"),ReadableStream=_require2.ReadableStream,ReadableStreamDefaultControllerClose=_require2.ReadableStreamDefaultControllerClose,ReadableStreamDefaultControllerEnqueue=_require2.ReadableStreamDefaultControllerEnqueue,ReadableStreamDefaultControllerError=_require2.ReadableStreamDefaultControllerError,ReadableStreamDefaultControllerGetDesiredSize=_require2.ReadableStreamDefaultControllerGetDesiredSize,ReadableStreamDefaultControllerHasBackpressure=_require2.ReadableStreamDefaultControllerHasBackpressure,ReadableStreamDefaultControllerCanCloseOrEnqueue=_require2.ReadableStreamDefaultControllerCanCloseOrEnqueue,_require3=_dereq_("./writable-stream.js"),WritableStream=_require3.WritableStream,WritableStreamDefaultControllerErrorIfNeeded=_require3.WritableStreamDefaultControllerErrorIfNeeded,TransformStream=function(){function TransformStream(){var r=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:void 0,a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},t=a.size,o=a.highWaterMark,n=void 0===o?0:o;if(_classCallCheck(this,TransformStream),this._transformer=r,void 0!==r.readableType)throw new RangeError("Invalid readable type specified");if(void 0!==r.writableType)throw new RangeError("Invalid writable type specified");this._transformStreamController=void 0;var l=new TransformStreamDefaultController(this);this._transformStreamController=l;var s=void 0,m=new Promise(function(r){s=r}),i=new TransformStreamDefaultSource(this,m),f={};createDataProperty(f,"size",t),createDataProperty(f,"highWaterMark",n),this._readable=new ReadableStream(i,f);var u=new TransformStreamDefaultSink(this,m);this._writable=new WritableStream(u,e),this._backpressure=void 0,this._backpressureChangePromise=void 0,this._backpressureChangePromise_resolve=void 0,TransformStreamSetBackpressure(this,!0);var S=InvokeOrNoop(r,"start",[l]);s(S)}return _createClass(TransformStream,[{key:"readable",get:function get(){if(!1===IsTransformStream(this))throw streamBrandCheckException("readable");return this._readable}},{key:"writable",get:function get(){if(!1===IsTransformStream(this))throw streamBrandCheckException("writable");return this._writable}}]),TransformStream}(),TransformStreamDefaultController=function(){function TransformStreamDefaultController(r){if(_classCallCheck(this,TransformStreamDefaultController),!1===IsTransformStream(r))throw new TypeError("TransformStreamDefaultController can only be constructed with a TransformStream instance");if(void 0!==r._transformStreamController)throw new TypeError("TransformStreamDefaultController instances can only be created by the TransformStream constructor");this._controlledTransformStream=r}return _createClass(TransformStreamDefaultController,[{key:"enqueue",value:function enqueue(r){if(!1===IsTransformStreamDefaultController(this))throw defaultControllerBrandCheckException("enqueue");TransformStreamDefaultControllerEnqueue(this,r)}},{key:"error",value:function error(r){if(!1===IsTransformStreamDefaultController(this))throw defaultControllerBrandCheckException("error");TransformStreamDefaultControllerError(this,r)}},{key:"terminate",value:function terminate(){if(!1===IsTransformStreamDefaultController(this))throw defaultControllerBrandCheckException("terminate");TransformStreamDefaultControllerTerminate(this)}},{key:"desiredSize",get:function get(){if(!1===IsTransformStreamDefaultController(this))throw defaultControllerBrandCheckException("desiredSize");var r=this._controlledTransformStream._readable._readableStreamController;return ReadableStreamDefaultControllerGetDesiredSize(r)}}]),TransformStreamDefaultController}(),TransformStreamDefaultSink=function(){function TransformStreamDefaultSink(r,e){_classCallCheck(this,TransformStreamDefaultSink),this._ownerTransformStream=r,this._startPromise=e}return _createClass(TransformStreamDefaultSink,[{key:"start",value:function start(){return this._startPromise}},{key:"write",value:function write(r){var e=this;verbose("TransformStreamDefaultSink.prototype.write()");var a=this._ownerTransformStream;return!0===a._backpressure?a._backpressureChangePromise.then(function(){var t=a._writable;if("erroring"===t._state)throw t._storedError;return TransformStreamDefaultSinkTransform(e,r)}):TransformStreamDefaultSinkTransform(this,r)}},{key:"abort",value:function abort(){var r=new TypeError("Writable side aborted");TransformStreamError(this._ownerTransformStream,r)}},{key:"close",value:function close(){verbose("TransformStreamDefaultSink.prototype.close()");var r=this._ownerTransformStream,e=r._readable;return PromiseInvokeOrNoop(r._transformer,"flush",[r._transformStreamController]).then(function(){if("errored"===e._state)throw e._storedError;var r=e._readableStreamController;!0===ReadableStreamDefaultControllerCanCloseOrEnqueue(r)&&ReadableStreamDefaultControllerClose(r)}).catch(function(a){throw TransformStreamError(r,a),e._storedError})}}]),TransformStreamDefaultSink}(),TransformStreamDefaultSource=function(){function TransformStreamDefaultSource(r,e){_classCallCheck(this,TransformStreamDefaultSource),this._ownerTransformStream=r,this._startPromise=e}return _createClass(TransformStreamDefaultSource,[{key:"start",value:function start(){return this._startPromise}},{key:"pull",value:function pull(){verbose("TransformStreamDefaultSource.prototype.pull()");var r=this._ownerTransformStream;return TransformStreamSetBackpressure(r,!1),r._backpressureChangePromise}},{key:"cancel",value:function cancel(r){TransformStreamErrorWritableAndUnblockWrite(this._ownerTransformStream,r)}}]),TransformStreamDefaultSource}();module.exports={TransformStream:TransformStream};
